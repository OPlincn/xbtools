...
#主界面
mainGNU() {
echo -e "\033[32m===============\033[0m\033[36m 小白工具V0.1 \033[32m===============\033[0m"
echo -e "本脚本最后修改于2019/3/31"
echo -e "作者OPlin | www.oplin.cn \n QQ:2450171559\n\n"
echo -e "1.VPS常用脚本整合"
echo -e "2.Liunx的一些命令"
echo -e "3.富强上网一键整合"
echo -e "4.Liunx一些软件安装"
echo -e "5.退出脚本"
echo -e "6.检查脚本更新"
...
echo -e "-------------------------------------------"
echo -e "1.安装魔改BBR四合一脚本(Locのcx9208大佬)"
echo -e "2.一键安装BBR(秋水逸冰大大)"
echo -e "-------------------------------------------\n"
echo -e "\033[43;34m "VPS测试脚本" \033[0m" #黄底蓝字
echo -e "-------------------------------------------"
echo -e "3.Superbench综合VPS测试(oooldking大佬)"
echo -e "4.SpeedTest测速脚本(Githubのsivel大佬)"
echo -e "5.UnixBench一键性能跑分(秋水逸冰大大)\n"
echo -e "-------------------------------------------\n"
echo -e "6.返回上一页\n"
...
#富强上网整理
richweb() {
echo -e "\n\033[31m 富强上网整理 \033[0m\n"
echo -e "\033[42;34m 个人使用类 \033[0m"
echo -e "-------------------------------------------"
echo -e "1.Shadowsocks四合一脚本(秋水大大)"
echo -e "2.ShaddowsocksR一键安装脚本[面板](逗比大佬)"
echo -e "3.一键安装Brook(逗比大佬)"
echo -e "-------------------------------------------\n"
echo -e "6.返回上一页\n"
...
test -d /home/xbct
if [ $? == "1" ]; then {
     mkdir /home/xbct && cd /home/xbct
   }
 else
   {
echo -e "脚本文件夹位于/home/xbct"; cd /home/xbct
   }
fi
#进入主界面
mainGNU
